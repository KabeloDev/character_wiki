...
class CharactersFromEpisodeScreen extends StatelessWidget {
  final List<String> characterUrls;

  const CharactersFromEpisodeScreen({super.key, required this.characterUrls});
  ...
  Future<List<dynamic>> fetchCharacters(List<int> ids) async {
    ...
    final uri = Uri.parse('https://rickandmortyapi.com/api/character/$idsString');
